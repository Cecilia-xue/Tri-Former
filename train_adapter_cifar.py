...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='/home/disk/result/trihit_adapter_cifar')
    ...
    parser.add_argument('--freeze_model_dir', type=str, default='/home/disk/result/trihit/cifar100//trihit_cth_cp/trihit_cth_best.pth')
