...
if __name__ == '__main__':
    ...
    # dataset and model
    parser.add_argument('--datapath', type=str, default='/home/disk/data/')
    ...
    parser.add_argument('--trained_weight_dir', type=str, default='/home/disk/result/trihit/Indian_pines/trihit_cth_cp/trihit_cth_best.pth')
    ...
    res_dir = os.path.join(res_save_dir, '{}_{}_res.npy'.format(args.model_name, args.sample_list))
    acc_dir = os.path.join(res_save_dir, '{}_{}_res.text'.format(args.model_name, args.sample_list))
    pred_map_text = os.path.join(res_save_dir, '{}_{}_res_map.text'.format(args.model_name, args.sample_list))
