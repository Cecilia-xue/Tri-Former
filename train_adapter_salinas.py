...
from utils import TxtLogger, cosine_scheduler, adapter_resume_dir_get
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/home/disk/data')
    parser.add_argument('--output', type=str, default='/home/disk/result/trihit_adapter_salinas')
    ...
    parser.add_argument('--freeze_model_dir', type=str, default='/home/disk/result/trihit/Salinas/trihit_cth_cp/trihit_cth_best.pth')
    parser.add_argument('--model_name', type=str, default='trihit_cth_zcp')
    ...
    if args.resume:
        start_epoch, resume_dir = adapter_resume_dir_get(args)
